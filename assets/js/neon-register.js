				...
				neonRegister.setPercentage(30, function()
				{
					...
					neonRegister.setPercentage(98, function()
					{
						...
						$.ajax({
							...
							error: function()
							{
								alert("Email and/or username are already in use or the values are invalid, make sure your inputs only contain regular characters and numbers ike the following example:Example123");
								window.location = "registerscreen.php";
							},
							success: function(response)
							{
								// From response you can fetch the data object retured
								var name = response.submitted_data.name,
									surname = response.submitted_data.surname,
